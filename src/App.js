...
import QuizBuilder from './Components/core/Dashboard/AddCourse/QuizBuilder/QuizBuilder';
import StudentQuiz from './Components/core/Dashboard/AddCourse/QuizBuilder/StudentQuiz';
  ...
  return (
    <div className=" w-screen min-h-screen bg-richblack-900 flex flex-col font-inter">
      ...
      <Routes>
        ...
        <Route path="/courses/:courseId/quiz" element={<StudentQuiz />} />
        ...
        >
          ...
          {user?.accountType === ACCOUNT_TYPE.INSTRUCTOR && (
            <>
              ...
              />
              <Route path="/dashboard/add-course/quizbuilder/:courseId" element={<QuizBuilder />} />
            </>
          )}
