...
function Home() {
    ...
    useEffect(() => {
        // Fetch all categories and set the first one's ID
    ...
    useEffect(() => {
        const fetchCatalogPageData = async () => {
            ...
            const result = await getCatalogaPageData(categoryID, dispatch, location.pathname);
            setCatalogPageData(result);
        };
        if (categoryID) {
            fetchCatalogPageData();
        }
    }, [categoryID, location.pathname, dispatch]);
  ...
  return (
    <div>
        <div className=' mx-auto relative flex flex-col w-11/12 items-center justify-between text-white '>
            ...
            Unlock Your Potential with Future-Ready  <HighlightText text={"Tech Skills"}/>
            </div>
            <div className=' mt-4 w-[90%] text-left md:text-center text-sm md:text-lg font-bold text-richblack-300'>
            EdTech platform makes it easy to begin learning coding and technology skills—at your own pace, from anywhere. Whether you're just starting out or exploring new topics, our beginner-friendly approach helps you build confidence and get future-ready. 
            </div>
            ...
            <div className='flex flex-row gap-7 mt-8'>
                ...
                <CTAButton active={false} linkto={"/login"} >Join Now</CTAButton>
            </div>

            <div className='mx-3 my-12 shadow-blue-200 w-[70%] relative'>
              <div className='grad2 -top-10 w-[800px]'></div>
              <div className="overflow-hidden rounded-lg border-4 border-white w-full max-w-2xl mx-auto transition-transform duration-500 hover:scale-105 shadow-lg hover:shadow-blue-400/50">
                <video
